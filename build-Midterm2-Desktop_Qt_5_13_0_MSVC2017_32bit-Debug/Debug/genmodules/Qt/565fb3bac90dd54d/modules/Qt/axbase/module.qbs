...
QtModule {
    ...
    hasLibrary: true
    staticLibsDebug: ["ole32","oleaut32","user32","gdi32","advapi32"]
    staticLibsRelease: ["ole32","oleaut32","user32","gdi32","advapi32"]
    dynamicLibsDebug: []
    dynamicLibsRelease: []
    linkerFlagsDebug: []
    linkerFlagsRelease: []
